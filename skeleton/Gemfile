...
group :development do
  ...
  gem 'ruby_dep', '<= 1.3.0',   :require => false if RUBY_VERSION < '2.2'
  gem 'listen', '< 3.1.0',      :require => false if RUBY_VERSION < '2.2'
end
...
group :system_tests do
  ...
  gem 'net-telnet', '< 0.2.0',         :require => false if RUBY_VERSION < '2.2'
